...
/* alternate solution for empty field alert.

document.querySelector('#incomeBtn').onclick = function() {
    if(document.querySelector('#name').value.length == 0) {
        alert("Please Enter an Income Name and Amount")
    }
}

document.querySelector('#expenseBtn').onclick = function() {
    if(document.querySelector('#name').value.length == 0) {
